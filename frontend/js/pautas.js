const datos = {
  "Reglas": {
    "cat1": {
      "name": "cat1 - ELIGIBILIDAD (ELIGIBILITY)",
    ...
    "cat2": {
      "name": "cat2 - Aplicacion de DIA/HORA (DAY/TIME)",
    ...
    "cat4": {
      "name": "cat4 - Aplicaciones de vuelo (FLIGHT APPLY)",
    ...
    "cat5": {
      "name": "cat5 - Reservas de emision de boletos por adelanto (ADV RES/TKTG)",
    ...
    "cat9": {
      "name": "cat9 - Transbordos (TRANSFERS)",
    ...
    "cat10": {
      "name": "cat10 - Combinabilidad (COMBINATIONS)",
    ...
    "cat11": {
      "name": "cat11 - Periodo de Embargo (BLACKOUTS)",
    ...
    "cat12": {
      "name": "cat12 - Recargos o sobre-cuotas (SURCHARGES)",
    ...
    "cat13": {
      "name": "cat13 - Viaje acompañado (ACCOMP TRAVEL)",
    ...
    "cat14": {
      "name": "cat14 - Restricciones de viaje (TRAVEL RESTRICTIONS)",
      "Descripcion": "Se usa cuando se establecen especificamente fechas de viaje en una norma. Contiene las fechas de inicio, expiracion y fin del viaje. Tambien indica si el viaje debe comenzar o terminar en una fecha/hora específica."
    },
    "cat15": {
      "name": "cat15 - Restricciones de venta (SALES RESTRICTIONS)",
    ...
    "cat16": {
      "name": "cat16 - Penalizaciones (PENALITIES)",
    ...
    "cat18": {
      "name": "cat18 - Endosos del boleto (TICKET ENDORSMENT)",
    ...
    "cat31": {
      "name": "cat31 - Cambios voluntarios (VOLUNTARY CHGS)",
